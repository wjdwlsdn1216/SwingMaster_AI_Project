...
class alphaposeDemo :
    ...
    def start(self) :
        ...
        parser.add_argument('--checkpoint', type=str, required=False,
                            help='checkpoint file name', default="./AlphaPose/pretrained_models/fast_res50_256x192.pth")
        ...
        parser.add_argument('--indir', dest='inputpath',
                            help='image-directory', default="./media/img")
        ...
        parser.add_argument('--posebatch', type=int, default=30,
